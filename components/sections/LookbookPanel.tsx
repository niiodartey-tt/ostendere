...
export function LookbookPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Caption */}
      <div
        className="relative z-[10] text-center max-w-[900px] reveal is-in"
        style={{ padding: '0 clamp(24px,5vw,72px)' }}
      >
        <span
          className="inline-flex items-center justify-center gap-3 mb-[22px]"
          style={{
