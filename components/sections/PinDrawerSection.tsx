        ...
        <div className="flex items-end justify-between gap-8 flex-wrap mb-[clamp(40px,6vh,80px)]">
          ...
          <RevealOnScroll delay={0.08}>
            <p style={{ fontSize: 'clamp(18px,1.5vw,22px)', color: '#b9ac97', maxWidth: '38ch', lineHeight: 1.5 }}>
              Cast, enamelled and stone-set lapel pins — figural crests to quiet geometry. Hover any tile for the name.
            </p>
          </RevealOnScroll>
        </div>
          ...
          >
            {PINS.map((pin) => (
              ...
              >
                ...
                >
                  <p style={{ fontFamily: 'var(--font-display)', color: '#ece3d2', fontSize: 18, lineHeight: 1.08 }}>
                    {pin.name}
                  </p>
                  <span
